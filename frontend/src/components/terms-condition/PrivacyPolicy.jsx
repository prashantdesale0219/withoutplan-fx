...
import { PrivacyPolicy as PrivacyPolicyData } from '@/data/termscondiiton';

const PrivacyPolicy = () => {
  const privacyData = PrivacyPolicyData[0];
    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <div className="relative overflow-hidden rounded-xl shadow-2xl">
        ...
        <div className="bg-gradient-to-r from-almond to-coffee p-6 text-white">
          ...
          <h1 className="text-5xl font-bold mt-1">{privacyData.title}</h1>
        </div>
        ...
        <div className="bg-white p-8">
          <div className="mb-8">
            ...
            <p className="text-coffee/80 dark:text-vanilla/80">{privacyData.intro}</p>
          </div>
          ...
          <div className="mt-10 pt-6 border-t border-almond/30 text-center">
            <p className="text-coffee/70 dark:text-vanilla/70 font-medium">Your privacy is our priority.</p>
          </div>
        </div>
      </div>
    </div>
