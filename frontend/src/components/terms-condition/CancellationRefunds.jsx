"use client"
import { CancellationsAndRefundsPolicy } from '@/data/termscondiiton';
import React from 'react';

const CancellationRefunds = () => {
  const refundsData = CancellationsAndRefundsPolicy[0];
    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <div className="relative overflow-hidden rounded-xl shadow-2xl">
        ...
        <div className="bg-gradient-to-r from-almond to-coffee p-6 text-white">
          ...
          <h1 className="text-5xl font-bold mt-1">{refundsData.title}</h1>
        </div>
        ...
        <div className="bg-white p-8">
          <div className="mb-8">
            ...
            <p className="text-coffee/80 dark:text-vanilla/80">{refundsData.intro}</p>
          </div>
          
          <div className="space-y-8">
            {refundsData.sections.map((section) => (
              <div key={section.id} className="border-l-4 border-almond pl-6 py-4 bg-vanilla/60 rounded-r-lg hover:bg-almond/10 transition-all">
          ...
          <div className="mt-10 pt-6 border-t border-almond/30 text-center">
            <p className="text-coffee/70 dark:text-vanilla/70 font-medium">For any refund inquiries, please contact our support team.</p>
          </div>
        </div>
      </div>
    </div>
